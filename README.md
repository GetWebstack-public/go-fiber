...
A REST API example built with [Fiber](https://gofiber.io/) — an Express-inspired web framework for Go built on top of Fasthttp.
...
```bash
git clone https://github.com/GetWebstack-public/go-fiber
cd go-fiber
```
